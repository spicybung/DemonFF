...
from .map_transform import GTA_EULER_ORDER, quaternion_to_gta_euler_degrees
...
def collect_placements(context, options):
    ...
    for obj in source_objects:
        ...
        rotation_values = quaternion_to_gta_euler_degrees(rotation)
        settings = get_mta_object_settings(obj)
        ...
        placement = {
            ...
            "y": float(position.y),
            "z": float(position.z),
            "rx": rotation_values[0],
            "ry": rotation_values[1],
            "rz": rotation_values[2],
...
def write_models_lua(resource_directory, assets):
    ...
    with open(path, "w", encoding="utf-8", newline="\n") as file:
        file.write("-- Generated by DemonFF 0.5.8\n")
...
def write_client_lua(resource_directory, create_placements=True):
    ...
    content = '''-- Generated by DemonFF 0.5.8
...
def apply_imported_placement(root, duplicated_objects, placement, model_key, model_id):
    ...
    root.rotation_mode = GTA_EULER_ORDER
    root.rotation_euler = (
